...
# Set paths.
params_file_relative='params/user_nl_opt_ALL_5yr_obs_full_24x48_16_SWCF_LWCF_PRECT_PSL_Z500_U200_U850_TREFHT_U_RELHUM_T_RESTOM_0.7_raw_MAP.txt' # relative path to params file. 
...
clone_case = f'validate.v3alpha02.{str(today.year)}{str(today.month)}{str(today.day)}_mincdnc_7.5e6'
print(clone_case)
