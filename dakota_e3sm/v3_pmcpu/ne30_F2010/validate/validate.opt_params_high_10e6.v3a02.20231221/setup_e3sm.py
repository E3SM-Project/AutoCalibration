...
# Set paths.
params_file_relative='params/user_nl.txt' # relative path to params file. 
validate_root = os.path.join( cfg['run_root'], cfg['ensemble_name'], 'validate')
...
#descriptor = 'opt_params_MAP_10e6_max_mincdnc'

#clone_case = f'validate.v3alpha02.{str(today.year)}{str(today.month)}{str(today.day)}.{descriptor}'
clone_case = 'validate.opt_params_high_10e6.v3a02.20231221'
print(clone_case)
...
cmd = '{}/cime/scripts/create_clone --keepexe --case {}/{} --clone {}/{}/case_scripts'.format(code_root, validate_root, clone_case, parent_dir, parent_case  )
print(cmd) 
os.system( cmd )
os.chdir( os.path.join( validate_root, clone_case ))
...
cmd = '{}/cime/scripts/create_clone --keepexe --case {}/{} --clone {}/{}/case_scripts'.format(code_root, validate_root, clone_case_p4k, parent_dir, parent_case  )
print(cmd) 
os.system( cmd )
os.chdir( os.path.join( validate_root, clone_case_p4k ))
if machine == 'compy':
...
os.system( f'cat {params_file_full} >> user_nl_eam')
