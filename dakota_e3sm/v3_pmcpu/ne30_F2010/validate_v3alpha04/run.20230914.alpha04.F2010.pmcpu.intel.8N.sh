...
# 20231016
# First attempt did not run due to lack of needed species in the restart files. Therefore I abandonn branch approach and will do a MODEL_START_TYPE="initial" like Wuyin, and copy the restart files from chrysalis. 
# 20231012
# Benjamin M. Wagman
# Based on Wuyin's run: https://acme-climate.atlassian.net/wiki/spaces/CM/pages/3939729500/20230918.v3alpha04.F2010.chrysalis
# Control run for v3alpha04
# Running as a branch off my original v3alpha02 case. Not sure if this will work. Also not providing wuyins land input files as those arent on perlmutter. I hope it does not matter. If so, I can move them over. 
...
readonly CASE_NAME="20230914.v3alpha04.F2010.pmcpu.intel.8N"

# Code and compilation
readonly CHECKOUT="20231009" # I checked out a branch "091423" and then did a git checkout of commit 84e50561a854e1888b0eaa52fc3a44287f3a5924. This put me on a detached head (HEAD detached at 84e50561a8)
readonly BRANCH="master" #head detached at 84e50561a8
readonly CHERRY=( )
...
readonly RUN_REFDIR="/pscratch/sd/w/wagmanbe/e3sm_input/lcrc/group/e3sm/ac.golaz/E3SMv3_dev/20230224.v3atm_v21.piControl.chrysalis/init"
...
# Set paths
readonly CODE_ROOT="${HOME}/E3SM/code/20231009"
...
cat << EOF >> user_nl_elm
 ...
 ! Use simyr1850 for one, replace with one for simyr2010 if available. Difference limited nevertheless

 fsurdat = '\${DIN_LOC_ROOT}/lnd/clm2/surfdata_map/surfdata_ne30pg2_simyr1850_c230417_with_TOP.nc'
 use_top_solar_rad = .true.
 finidat = '/pscratch/sd/w/wagmanbe/e3sm_input/lcrc/group/e3sm2/ac.golaz/E3SMv3_dev/20230914.v3alpha03_bigrid.piControl.chrysalis/init/20230901.v3alpha02.bi_grid.ELMSP_TOP.spinup.chrysalis.elm.r.0101-01-01-00000.nc'
