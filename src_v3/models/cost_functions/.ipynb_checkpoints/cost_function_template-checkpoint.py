...
def rmse(y, yhat, area_weights=None, s=1.0):
    ...
    s : numpy array of shape (ncol,) containing normalizing values for the output variable; default is the scalar value 1.0, which is equivalent to np.repeat(1.0, ncol)
